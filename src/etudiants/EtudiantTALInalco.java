...
public class EtudiantTALInalco extends EtudiantTAL {
	...
	public static void main(String[] args) {
		...
		System.out.println(etudianteLeonard.imprimerID(etudianteLeonard.nom,etudianteLeonard.numeroEtudiant, etudianteLeonard.langue));

		System.out.println(etudianteLeonard.imprimerID(etudianteLeonard.nom,etudianteLeonard.numeroEtudiant, "allemand"));
		//System.out.println("nom de Bernard="+etudianteLeonard.nom + "age="+etudianteLeonard.age + "langue=" +etudianteLeonard.langue);
