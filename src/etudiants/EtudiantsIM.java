...
public class EtudiantsIM {
	...
	public static void main(String[] args) {
		...
		System.out.println(etudianteMylene);
		 ...
		 * 
		 * 
		 * EtudiantTALInalco etudianteTata = new EtudiantTALInalco("Tata",
		 * 22,"italien"); profDeJava.setEtudiantDeteste(etudianteTata);
		 * 
		 * EtudiantTAL etudianteToto = new EtudiantTAL("Toto", 52); /// KO:
		 * profDeJava.setEtudiantDeteste(etudianteToto);
		 ...
		 * System.out.println("ville Gerard="+etudianteGerad.getVille());
		 * 
		 * String[] matieres= new String[5]; EtudiantTAL EtudiantArthur= new
		 * EtudiantTAL(matieres);
		 * 
		 */
